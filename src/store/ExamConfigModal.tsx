...
export function ExamConfigModal({
  ...
  // page is wrapped in <PageWrapper>, a framer-motion div that animates via
  // an inline `transform`, which becomes the containing block for any
  // `position: fixed` descendant — without the portal this backdrop renders
  // as a small black box instead of a full-screen overlay.
  return createPortal(
    <AnimatePresence>
      <motion.div
