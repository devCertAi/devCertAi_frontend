  ...
  return (
    <PageWrapper className="bg-[var(--color-bg)] pl-0 lg:pl-39">
      <div className="px-4 sm:px-6 lg:px-10 pt-8 pb-16">
        ...
        {!user?.isPremium && (
          <div className="flex justify-center mb-8"><AdBanner slot="topBanner" size="banner" className="w-full max-w-3xl" /></div>
        )}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="space-y-6">
            <CreditWidget />
            <Card className="p-6 flex flex-col max-h-[420px]">
              <h2 className="font-semibold text-[var(--color-text)] mb-5 shrink-0">Recent Activity</h2>
              {loading ? (
                <div className="space-y-3">
